...
#| results: asis
tw_plot$cat_plot(p, "purity_range", group = "ppl_other")
tw_plot$cat_plot(p, "segment", group = "ppl_other")
tw_plot$cat_plot(p, "clonality", group = "ppl_other")
tw_plot$cat_plot(p, "cn_distro", group = "ppl_other")
tw_plot$cat_plot(p, "map_distro", group = "ppl_other")
tw_plot$cat_plot(p, "somatic_cnpdf", group = "ppl_other")
tw_plot$cat_plot(p, "rainfall", group = "ppl_other")
```
